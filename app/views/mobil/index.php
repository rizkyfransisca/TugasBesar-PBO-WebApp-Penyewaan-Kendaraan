    ...
    <div class="body-wrapper">
        ...
        <main>
            <header class="d-flex justify-content-between">
                <h1 class="page-title align-self-center">Cars</h1>
                    ...
                    <table id="cars" class="table table-striped table-bordered" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $mobil["tahun"] ?></td>
                                <td><?= $mobil["warna"] ?></td>
                                <td class="c-col">Rp <?= number_format($mobil["harga_sewa"],0,',','.'); ?></td>
                                <td class="u-col"><?= $mobil["total_unit"] ?> unit</td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Sun Roof</td>
                                <td>:</td>
                                <td id="detail_isSunRoof"></td>
                            </tr>
                            <tr>
                                <td>Cruise Control</td>
                                <td>:</td>
                                <td id="detail_cruise_control"></td>
                            </tr>
                            <tr>
                                <td>Total</td>
                                <td>:</td>
